...
static NSString * const kConsumerKey       = @"HaLjGScytWIeobaL11IbIg";
static NSString * const kConsumerSecret    = @"bhpb_Di_oZiMvk67R6nCfOF_vDM";
static NSString * const kToken             = @"JQw2VDRY12KHaFt0aoLlaqzhIh-2YTRO";
static NSString * const kTokenSecret       = @"n9SDQlxwkUWmDwohfavpvlxw-Ow";
